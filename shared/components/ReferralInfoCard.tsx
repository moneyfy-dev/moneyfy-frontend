...
import { ReferredPersonalData, ReferredAddressData } from '@/core/types/referral';

interface ReferralInfoCardProps {
  personalData: ReferredPersonalData;
  addressData: ReferredAddressData;
}

export const ReferralInfoCard = ({ personalData, addressData }: ReferralInfoCardProps) => {
